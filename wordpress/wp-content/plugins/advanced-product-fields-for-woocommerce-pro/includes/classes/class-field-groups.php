...
namespace SW_WAPF_PRO\Includes\Classes {
	...
	class Field_Groups
    {
        ...
        public static function get_field_groups_of_product($product) {
	        ...
	        if($field_group_on_product && !empty($field_group_on_product->fields))
        ...
        public static function process_data($data) {
        	...
        	$definitions = Fields::get_field_definitions();
	        ...
	        if(is_serialized($data)) {
	        	try{
	        		...
	        		if(is_array($unserialized)) {
						$fg = new FieldGroup();
						return $fg->from_array($unserialized, $definitions);
			        }
	        ...
	        if(is_array($data)) {
		        $fg = new FieldGroup();
		        return $fg->from_array($data, $definitions);
	        }
